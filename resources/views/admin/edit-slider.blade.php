              ...
              <form method="post" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Enter Some Details of Slider" name="details" maxlength="50" required value="{{$slider->details}}">
                  </div>
                  <div class="form-group">
