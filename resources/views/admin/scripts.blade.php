...
<script src="{{asset('admin/plugins/jquery.flot.resize.js')}}"></script>
<!-- FLOT PIE PLUGIN - also used to draw donut charts -->
<script src="{{asset('admin/plugins/jquery.flot.pie.js')}}"></script>
<!-- Page specific script -->
<script>
  $(function () {
    /*
...
<script type="text/javascript">
  ...
  function show()
  {
    var add_class = document.getElementById('drop-noti');
    add_class.classList.add('show');

    document.getElementById('remove_class').onclick=hide;
  }
  ...
  function hide()
  {
    ...
    document.getElementById('remove_class').onclick=show;
  }
